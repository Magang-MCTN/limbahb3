                ...
                <div class="container">
                    ...
                    <form method="post" action="{{ route('timk3.submitFormNeraca2', $bulan->id_bulan) }}">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="d-flex ps-3">
                                        <textarea name="no_izin_limbah_klh" class="border" style="width: 34vw; border: 1px; border-radius: 5px;" rows="4"></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col ms-2">
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <textarea name="catatan" class="border" style="width: 40vw; border:1px; border-radius: 5px" rows="10"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-end mt-3">
                            <button class="btn btn-primary" type="submit" style="background-color:#097B96; color: white" onmouseover="this.style.backgroundColor='#0B697F'" onmouseout="this.style.backgroundColor='#097B96'">Simpan</button>
                        </div>
                    </form>
                </div>
            </div>
