...
@section('content')
<div class="container">
    <h2>Formulir Pengisian Limbah Keluar</h2>
    ...
    <form id="form-limbah-keluar">
        ...
        <div class="form-group">
            ...
            <input type="number" name="jumlahkg" class="form-control" required>
        </div>
        ...
        <div class="d-flex justify-content-end mt-3">
            <button class="btn btn-primary" type="button" id="tambahData">Tambah Limbah keluar</button>
        </div>
    </form>
